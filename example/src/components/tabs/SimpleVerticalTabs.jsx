...
class SimpleVerticalTabs extends React.Component {
    ...
    <div className={classes.root}>
      ...
      {value === 0 && <TabContainer value={value} index={0} className={classes.tabContent}> Showing Back tab </TabContainer>}
      {value === 1 && <TabContainer value={value} index={1} className={classes.tabContent}> Showing contents tab </TabContainer>}
      {value === 2 && <TabContainer value={value} index={2} className={classes.tabContent}> Showing History tab </TabContainer>}
      {value === 3 && <TabContainer value={value} index={3} className={classes.tabContent}> Showing NoteBook tab </TabContainer>}
      {value === 4 && <TabContainer value={value} index={4} className={classes.tabContent}> Showing Study tab </TabContainer>}
      {value === 5 && <TabContainer value={value} index={5} className={classes.tabContent}> Showing Resources tab </TabContainer>}
    </div>
  );
}
}
